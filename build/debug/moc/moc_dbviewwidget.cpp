...
#include "../../../src/widgets/dbviewwidget/dbviewwidget.h"
...
QT_MOC_LITERAL(1, 13, 15), // "actionTriggered"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 6), // "action"
QT_MOC_LITERAL(4, 37, 8), // "setState"
QT_MOC_LITERAL(5, 46, 5), // "state"
QT_MOC_LITERAL(6, 52, 12), // "updateFilter"
QT_MOC_LITERAL(7, 65, 6), // "column"
QT_MOC_LITERAL(8, 72, 5), // "value"
QT_MOC_LITERAL(9, 78, 16), // "popupContextMenu"
QT_MOC_LITERAL(10, 95, 8) // "position"

    },
    "DbViewWidget\0actionTriggered\0\0action\0"
    "setState\0state\0updateFilter\0column\0"
    "value\0popupContextMenu\0position"
};
...
void DbViewWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->updateFilter((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 3: _t->popupContextMenu((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (DbViewWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DbViewWidget::actionTriggered)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DbViewWidget::actionTriggered(int _t1)
{
