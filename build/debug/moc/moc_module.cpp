...
#include "../../../src/baseclasses/module.h"
...
QT_MOC_LITERAL(3, 20, 16), // "QList<MediaInfo>"
QT_MOC_LITERAL(4, 37, 8) // "finished"

    },
    "Module\0pageFetched\0\0QList<MediaInfo>\0"
    "finished"
};
...
void Module::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pageFetched((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< const QList<MediaInfo>(*)>(_a[3]))); break;
        ...
        {
            typedef void (Module::*_t)(int , int , const QList<MediaInfo> & );
...
// SIGNAL 0
void Module::pageFetched(int _t1, int _t2, const QList<MediaInfo> & _t3)
{
